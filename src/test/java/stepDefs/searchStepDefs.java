...
import static utils.SetUpDriver.driver;
import static utils.SetUpDriver.initializeDriver;
...
public class searchStepDefs {
    ...
    public void i_am_in_home_page() {
        WebDriver driver = SetUpDriver.initializeDriver();
    ...
    public void i_close_pop_up_ads() {
        this.homePage.clickClosePopUpBtn();
    }
